...
class ExtensionRangeOptions extends $pb.GeneratedMessage {
  ...
  /// NOTE: flip the default to DECLARATION once all empty ranges
...
class FileOptions extends $pb.GeneratedMessage {
  ...
  ///
  ///  NOTE: clarify exactly what kinds of field types this option
...
class MessageOptions extends $pb.GeneratedMessage {
  ...
  ///
  ///  NOTE This is legacy behavior we plan to remove once downstream
...
class FieldOptions extends $pb.GeneratedMessage {
  ...
  /// NOTE: make ctype actually deprecated.
  @$pb.TagNumber(1)
...
class EnumOptions extends $pb.GeneratedMessage {
  ...
  /// The new behavior takes `json_name` into account and applies to proto2 as
  /// well.
  /// NOTE Remove this legacy behavior once downstream teams have
  /// had time to migrate.
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(6)
...
/// NOTE Enums in C++ gencode (and potentially other languages) are
